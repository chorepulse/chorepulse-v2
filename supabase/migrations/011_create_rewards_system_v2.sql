...
CREATE INDEX idx_rewards_organization ON rewards(organization_id);
...
CREATE INDEX idx_reward_templates_popularity ON reward_templates(popularity DESC);
